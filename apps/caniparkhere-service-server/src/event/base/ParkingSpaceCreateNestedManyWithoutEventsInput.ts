...
@InputType()
class ParkingSpaceCreateNestedManyWithoutEventsInput {
...
export { ParkingSpaceCreateNestedManyWithoutEventsInput as ParkingSpaceCreateNestedManyWithoutEventsInput };
