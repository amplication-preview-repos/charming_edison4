...
export class BookingResolverBase {
  ...
  async createBooking(
    ...
    return await this.service.createBooking({
      ...
      data: {
        ...
        parkingSpace: args.data.parkingSpace
          ? {
              connect: args.data.parkingSpace,
            }
          : undefined,
      },
    });
  ...
  async getDriver(@graphql.Parent() parent: Booking): Promise<Driver | null> {
  ...
  async getParkingSpace(
    ...
    const result = await this.service.getParkingSpace(parent.id);
